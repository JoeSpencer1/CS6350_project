...
[Materials]
  ...
  [stress_wrapped]
    ...
    objective_rate='green_naghdi'#'jaumann'
  []

  [tensor_2]
    type = ComputeIsotropicElasticityTensor
    block = '2'
    youngs_modulus = ${E} #E, GPa
    poissons_ratio = ${nu} #ν
  []
  [power_law_hardening]
    type = IsotropicPowerLawHardeningStressUpdate
    strength_coefficient = ${K} #K, GPa
    strain_hardening_exponent = ${n} #n
    block = '2'
  []
...
[Outputs]
  ...
  file_base = '${prefix}${base}_l_${refi}_${ref}${suffix}'
[]
...
[Contact]
  [ind_base] # Frictional
    ...
    penalty = ${contact_penalty} #1e5#1e4
